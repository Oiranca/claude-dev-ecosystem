...
- **Budget**: Check `.agent-cache/skill_budget_state.json` when present. This falls under Broader Validation (Max 2 runs/cycle, max 1/skill).
...
3. **Communicate**: Post the audit summary to the **Shared Task List** so the Team Lead can review findings.
