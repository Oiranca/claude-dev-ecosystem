...
- **Budget**: Check `.agent-cache/skill_budget_state.json`. Max 1 run per cycle; requires explicit justification.
- **Skip Conditions**:
...
3. **Communicate**: Post the summary to the **Shared Task List**.
