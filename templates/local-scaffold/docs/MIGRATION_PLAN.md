...
- [ ] Relevant repository inventory and route map are available.
- [ ] Architecture plan defines the active migration milestone.
- [ ] Scope is limited to the current migration batch.

## Migration Scope
Describe the active migration objective and the systems in scope.
